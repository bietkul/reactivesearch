				...
				<Base>
					<Navbar style={{ backgroundColor: primary, color: '#fff' }} bold dark>
						...
						<Navbar.List>
							...
							<li className="button">
								<Button style={{ backgroundColor: '#324754', opacity: 0.7 }} href={config.urls.support} uppercase>
					...
					<div className={banner(config.banner1.image.src, primary)}>
						<Layout>
							<div className="content">
								...
								<p style={{ opacity: 0.7 }}>{config.banner1.description}</p>
								<div className="button-row">
									...
									<SecondaryLink style={{ opacity: 0.7 }} href={config.banner1.link.href}>
